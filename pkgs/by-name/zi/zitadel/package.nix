{
  ...
  zitadelRepo = fetchFromGitHub {
    ...
    repo = "zitadel";
    rev = "v${version}";
    hash = "sha256-z4drDjr0p7tl7lPIr4zqJ7YnFA3a3RUC1MzEtuNuCvs=";
  };
  goModulesHash = "sha256-8Exsz1wU043tt6nXJsjVyhleb9UYHJEkoYvk4CtohC4=";
  ...
  protobufGenerated = generateProtobufCode {
    ...
    hash = "sha256-zyIlae1FHlR0ePyIG01IvS69c+b8UIoWIXjw770EX0A=";
  };
in
  buildGoModule rec {
    name = "zitadel";
